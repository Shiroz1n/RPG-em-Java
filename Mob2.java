...
public class Mob2 extends Personagem {
    String nome="Chemical";
    String descricao="Uma nuvem de poluiçao que ganhou vida por conta do mutagênico(mais fortes que o trasher e mais resistentes.";
   
    private int vida=20;
    private int dano=6;
    private double armadura=6;
